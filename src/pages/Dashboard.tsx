  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        ...
        <StatsCard label="Hospitals Connected" value={dashboardStats.connectedHospitals} icon={<Activity size={20} />} />
        <StatsCard label="Pending Merges" value={dashboardStats.pendingMerges} icon={<GitMerge size={20} />} trend="3 critical" />
        <StatsCard label="Today's Searches" value={dashboardStats.todaySearches} icon={<Search size={20} />} trend="+12% vs yesterday" trendUp />
        <StatsCard label="Active Alerts" value={dashboardStats.activeAlerts} icon={<AlertTriangle size={20} />} />
      </div>

      <div className="grid gap-6 lg:grid-cols-2">
        {/* Staging queue preview */}
