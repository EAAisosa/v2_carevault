import { hospitalConnectors } from "@/data/mockData";
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  ...
                  <p className="font-semibold text-foreground">{c.recordsCount.toLocaleString()}</p>
                </div>
                <div>
                  <span className="text-muted-foreground">EHR System</span>
                  <p className="font-semibold text-foreground">{c.ehrSystem}</p>
                </div>
              </div>

              <div className="flex items-center justify-between border-t pt-3">
                <span className="text-[10px] text-muted-foreground font-mono">
                  Last sync: {new Date(c.lastSync).toLocaleString("en-NG", { month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" })}
                </span>
